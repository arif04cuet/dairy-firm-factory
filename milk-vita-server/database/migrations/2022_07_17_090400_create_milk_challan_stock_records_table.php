...
class CreateMilkChallanStockRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('milk_challan_stock_records', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('milk_challan_stock_records');
    }
}
