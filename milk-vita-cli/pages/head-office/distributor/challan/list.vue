        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="m-0 mt-2">
                    ...
                    <span>ডিস্ট্রিবিউটর চালানের তালিকা</span>
                </h5>
                <!-- <div class="btn-group">
                ...
                <table class="table table-bordered table-hover custom mb-2">
                    ...
                    <tbody>
                        <tr v-for="(row, index) in challans" :key="index">
                            ...
                            <td>{{row.total_challan_quantity}}</td>
                            <td class="text-capitalize">{{row.status}}</td>
                            <td class="text-center">
                                <div class="btn-group custom">
                                    <button class="btn btn-info" @click="view(row)" v-if="$ck_action('/head-office/distributor/challan/view')">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                </div>
                            </td>
                        ...
                        <tr v-if="(challans.length <= 0)">
                            <th colspan="9">কোনো অর্ডার পাওয়া যায়নি </th>
                        </tr>
                    </tbody>
                </table>
                <!-- ------------------ PAGINATION ------------------ -->
                <div class="d-flex justify-content-end">
                    <pagination v-model="page_no" :records="total_row" :per-page="per_page" @paginate="allChallan"/>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            view(row){
                this.$router.push({path:'/head-office/distributor/challan/view?id='+row.id});
            },
            edit(row){
            ...
            allChallan(){
                this.loader = true;
                this.http('head-office/distributor/challan/list', 'challans', {
