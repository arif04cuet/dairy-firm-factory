...
<script>
    ...
    export default {
        ...
        methods:{
            submit(form){
                this.is_submit = true;
                this.http('chilling-plant/update/'+this.edit_id, 'update', this.form);
            },
        ...
        watch:{
            ...
            edit_id(){
                this.http('chilling-plant/all', 'edit-data', {
                    where:{
                        id:this.edit_id
                    }
                });
                ...
                for(const key in this.kernel){
                    if(key=='plants'){
                        ...
                        if(this.kernel[key].errors){
                            ...
                            this.$toastr.s('চিলিং প্লান্ট সফলভাবে আপডেট করা হয়েছে');
                            this.$router.push({path:'/chilling-plant/all'});
                        }
                    }
                    else if(key=='edit-data'){
