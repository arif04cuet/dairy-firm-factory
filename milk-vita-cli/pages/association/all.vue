    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="m-0 mt-2">প্রস্তাবিত প্রাথমিক দুগ্ধ উৎপাদনকারী সমিতির তালিকাঃ</h5>
                <div class="btn-group">
                        ...
                        <tr v-for="(row, index) in paginate_associations" :key="index">
                            ...
                            <td class="text-center">
                                <div class="btn-group custom">
                                    <button class="btn btn-success" @click="quick_info(row.id)" v-if="$ck_action('/association/primary-data-view')">
                                        <i class="fa fa-eye"></i>
                                    </button>

                                    <button class="btn btn-primary" @click="edit(row)" v-if="$ck_action('/association/edit')">
