            ...
            <div class="card-body min85vh">
                <div v-if="loader==false">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 pt-2" v-if="user">{{$en2bn(user.association_code)}}</div>
                        <!-- // -->
...
<script>
    export default {
        ...
        mounted(){
            this.http('association/milk/stock', 'stock');
        },
        methods:{
            submit(){
                if((this.stock > 0) && (this.form.amount_of_milk > 0)){
                    this.is_submit = true;
                    this.http('association/milk/challan-submit', 'submit', this.form);
                }
                else {
        ...
        watch:{
            kernel(){
                for(const key in this.kernel){
                    if(key=='stock'){
                        this.form.amount_of_milk = (this.kernel[key].amount);
                        ...
                        if(this.kernel[key].errors){
                            ...
                            this.$router.push({path:'/association/manager/challan/view?id='+(this.kernel[key].id)});
                        }
