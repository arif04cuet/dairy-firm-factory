    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="m-0 mt-2"><i class="fa fa-list"></i>&nbsp;ব্যবহৃত কাঁচামাল তালিকা</h5>
                <div class="btn-group">
                    <nuxt-link to="/raw-material/use/add" class="btn btn-primary" v-if="$ck_action('/raw-material/use/add')">
                        <i class="fa fa-plus"></i>&nbsp;ব্যবহৃত কাঁচামাল যোগ করুন
                    </nuxt-link>
                </div>
            </div>
        </div>
                        ...
                        <tr v-for="(row, index) in vouchers" :key="index">
                            ...
                            <td class="text-center">
                                <div class="btn-group custom">
                                    <nuxt-link :to="'/raw-material/use/view?id='+row.id" v-if="$ck_action('/raw-material/use/view')">
                                        <button class="btn btn-info">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </button>
                                    </nuxt-link>
                                    <!-- // -->
                                    <nuxt-link :to="'/raw-material/use/edit?id='+row.id" v-if="$ck_action('/raw-material/use/edit')">
                                        <button class="btn btn-primary">
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </button>
                                    </nuxt-link>
                                    <!-- // -->
                                    <nuxt-link to="#" v-if="$ck_action('/raw-material/use/destroy')">
            ...
            destroy(id){
                ...
                .then((result) => {
                    if(result.isConfirmed) {
                        this.http('raw-material/use/destroy/'+id, 'destroy');
                    }
                })
            },
            getVouchers(){
                this.loader = true;
                this.http('raw-material/use/list', 'list', {
