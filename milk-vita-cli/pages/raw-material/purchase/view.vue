                ...
                <table class="table table-bordered custom">
                    ...
                    <tbody>
                        <tr v-for="(row, index) in data.items" :key="index">
                            ...
                            <td width="130">{{number(row.quantity)}}</td>
                            <td width="130">{{number(row.price)}}</td>
                            <td width="70">{{number(row.quantity * row.price)}}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-right">{{number(total_price * total_quantity)}}</td>
                        </tr>
                    </tbody>
                </table>
...
<script>
    export default {
        ...
        mounted(){
            this.http('raw-material/purchase/view/'+this.$route.query.id, 'view');
        },
        methods:{
