    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="m-0 mt-2"><i class="fa fa-list"></i> সকল ক্রয় তালিকা</h5>
                <div class="btn-group">
                    <nuxt-link to="/raw-material/purchase/add" class="btn btn-primary" v-if="$ck_action('/raw-material/purchase/add')">
                        <i class="fa fa-plus"></i>&nbsp;নতুন ক্রয় যোগ করুন
                    </nuxt-link>
                </div>
            </div>
        </div>
                        ...
                        <tr v-for="(row, index) in vouchers" :key="index">
                            ...
                            <td class="text-center">
                                <div class="btn-group custom">
                                    <nuxt-link :to="'/raw-material/purchase/view?id='+row.id" v-if="$ck_action('/raw-material/purchase/view')">
...
<script>
    export default {
        ...
        methods:{
            ...
            getVouchers(){
                this.loader = true;
                this.http('raw-material/purchase/list', 'list', {
