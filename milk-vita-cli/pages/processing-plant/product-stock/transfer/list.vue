    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div class="btn-group">
                    <NuxtLink to="/processing-plant/product-stock/transfer/add" class="btn btn-primary" v-if="$ck_action('/processing-plant/product-stock/transfer/add')">
                        ...
                        <tr v-for="(row, index) in records" :key="index" >
                            ...
                            <td class="text-center">
                                <div class="btn-group custom">
                                    <nuxt-link class="btn btn-success" :to="'/processing-plant/product-stock/transfer/view?id='+row.id" v-if="$ck_action('/processing-plant/product-stock/transfer/view')">
                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                    </nuxt-link>
                                    <!-- // -->
                                    <nuxt-link class="btn btn-primary" :to="'/processing-plant/product-stock/transfer/edit?id='+row.id" v-if="$ck_action('/processing-plant/product-stock/transfer/edit') && row.is_receive==0">
                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                    </nuxt-link>
                                    <!-- // -->
                                    <nuxt-link class="btn btn-danger" to="#" v-if="$ck_action('/processing-plant/product-stock/transfer/delete') && row.is_receive==0">
...
<script>
    export default {
        ...
        methods:{
            ...
            fetchrecords(){
                this.loader = true;
                this.http('stock-transfer/finish-product/list', 'records', {
