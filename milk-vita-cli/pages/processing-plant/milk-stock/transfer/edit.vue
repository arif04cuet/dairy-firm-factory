                ...
                <div class="text-right">
                    <div class="btn-group">
                        <button :type="is_submit==true?'button':'submit'" class="btn btn-success" style="min-width:127px">
                            ...
                            <span v-else ><i class="fa fa-floppy-o"></i>&nbsp;আপডেট করুন</span>
                        </button>
                    </div>
                </div>
            </form>
...
export default {
    ...
    methods: {
        submit: function () {
            this.is_submit = true;
            this.http("stock-transfer/milk-send/update/"+this.$route.query.id, "update", this.challan);
        },
            ...
            for (const key in this.kernel) {
                if(key == "update") {
                    if(this.kernel[key].errors)
                        ...
                        this.$toastr.s("সফলভাবে আপডেট হয়েছে");
