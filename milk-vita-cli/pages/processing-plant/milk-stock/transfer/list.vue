                        ...
                        <tr v-for="(row, index) in records" :key="index" >
                            ...
                            <td class="text-center">
                                <div class="btn-group custom">
                                    <nuxt-link :to="'/processing-plant/stock/transfer/view?id='+row.id" v-if="$ck_action('/processing-plant/stock/transfer/view')">
                                        <button class="btn btn-success">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </button>
                                    </nuxt-link>
                                    <!-- // -->
                                    <nuxt-link :to="'/processing-plant/stock/transfer/edit?id='+row.id" v-if="$ck_action('/processing-plant/stock/transfer/edit') && row.is_receive==0">
                                        <button class="btn btn-primary">
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </button>
                                    </nuxt-link>
                                    <!-- // -->
                                    <nuxt-link to="#" v-if="$ck_action('/processing-plant/stock/transfer/delete') && row.is_receive==0">
...
<script>
    export default {
        ...
        methods:{
            ...
            fetchrecords(){
                this.loader = true;
                this.http('stock-transfer/milk-send/list', 'records', {
