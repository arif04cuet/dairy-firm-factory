    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="m-0 mt-2"><i class="fa fa-calculator" aria-hidden="true"></i>&nbsp;&nbsp;কিউ.সি / চালান</h5>
            </div>
        </div>
        <div class="card-body min75vh">
            ...
            <div class="table-responsive" v-if="!loader">
                ...
                <div class="d-flex justify-content-end">
                    <pagination v-model="page_no" :records="total_row" :per-page="per_page" @paginate="fetchChallans"/>
                </div>
