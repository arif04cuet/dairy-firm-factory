    ...
    <div class="card">
        ...
        <div class="card-body min75vh">
            <form @submit.prevent="submit()">
                ...
                <!-- // -->
                <Location v-if="location_data" v-model="location_data">
                    <div class="row form-group">
                ...
                <!-- // -->
                <div class="row form-group">
                    <label for="" class="col-md-3 text-md-right">প্রসেসিং প্লান্টের ঠিকানা</label>
                    <div class="col-md-6">
                        <textarea
                            type="text"
                            class="form-control"
...
export default {
    ...
    methods: {
        submit: function () {
            this.is_submit = true;
            this.http("processing-plant/update/"+this.editable_id, "update", this.form);
        },
    ...
    watch: {
        ...
        editable_id(){
            this.http('processing-plant/all', 'editable', {
                where:{id:this.editable_id}
            });
        },
        kernel: function () {
