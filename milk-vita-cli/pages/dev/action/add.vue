    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="m-0 mt-2"><i class="fa fa-hashtag" aria-hidden="true"></i>&nbsp;নতুন অ্যাকশন মেনু তৈরী করুন</h5>
                <div class="btn-group">
        ...
        <div class="card-body min75vh">
            <form @submit.prevent="submit()">
                ...
                <div class="row form-group">
                    <label for="path" class="col-md-4 text-md-right mt-2">স্লাগ (If any)</label>
                    <div class="col-md-6">
                        <input type="text" v-model="form.slug" id="url" class="form-control" placeholder="স্লাগ/মডিউল">
                    </div>
                </div>
...
<script>
    export default {
        ...
        methods:{
            submit(){
                this.http('action-menu/store', 'store', this.form);
            },
