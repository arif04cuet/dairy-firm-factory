...
<script>
    export default {
        ...
        mounted(){
            ...
            this.http('product/price/list', 'price', {
        ...
        methods:{
            submit(){
                ...
                {
                    this.http('product/price/update/'+this.$route.query.id, 'store', this.form);
                }
                else {
                    this.$toastr.w("কোনো একটি সমস্যার কারণে প্রসেস সম্পন্ন হয়নি ");
                }
            },
                ...
                for(const key in this.kernel){
                    if(key=='store'){
                        if(this.kernel[key].errors){
                            ...
                            this.$toastr.s("মূল্যের লেবেল সফলভাবে আপডেট করা হয়েছে৷");
