    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="m-0 mt-2"><i class="fa fa-plus"></i> নতুন ফিনিশ পণ্য যোগ করুন </h5>
                <div class="btn-group">
        ...
        <div class="card-body min75vh">
            ...
            <!-- // -->
            <div class="btn-group float-right mt-2" v-if="items.length > 0">
                <!-- // -->
...
<script>
    export default {
        ...
        methods:{
            ...
            submit(){
                this.is_submit = true;
                this.http('product/finish/store', 'store', {items:this.items});
            },
