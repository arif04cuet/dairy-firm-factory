        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="m-0 mt-2">
                    ...
                    কোল্ড রুমে তরল দুধ স্থানান্তর
                </h5>
                <div class="btn-group">
                    <nuxt-link to="/reports/transfer-milk-to-cold-room/add" class="btn btn-primary" v-if="$ck_action('/reports/transfer-milk-to-cold-room/add')">
                ...
                <table class="table table-bordered table-hover custom mb-2">
                    ...
                    <tbody>
                        <tr v-for="(row, index) in records" :key="index">
                            ...
                            <td>{{row.total_cream}}</td>
                            <td>{{row.total_cream_can}}</td>
                            <td>{{row.total_packet}}</td>
                            <td>{{row.bulk_milk}}</td>
                            <td>{{row.total}}</td>
                            <td class="text-center">
                                <div class="btn-group custom">
                                    <nuxt-link :to="'/reports/transfer-milk-to-cold-room/view?id='+row.id" v-if="$ck_action('/reports/transfer-milk-to-cold-room/view')">
...
<script>
    export default {
        ...
        methods:{
            ...
            fetchAllResolution(){
                this.loader = true;
                this.http('report/transfer-milk-to-cold-room/list', 'records', {
