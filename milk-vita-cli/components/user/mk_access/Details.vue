<template>
    <div class="card-body">
        <form @submit.prevent="submit()">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" placeholder="Enter Full Name" v-model="form.name_bn" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" placeholder="Enter Mobile No" v-model="form.mobile" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-8">
                            <input type="email" class="form-control" placeholder="Enter E-mail Address" v-model="form.email" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" v-model="form.processing_plant_id" disabled>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" v-model="form.role_id" disabled>
                    ...
                    <div class="row form-group">
                        <label class="col-md-3 text-md-right mt-1" for="name">Username</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" placeholder="Username" v-model="form.username" :readonly="view_id"> 
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <select class="form-control" v-model="form.division_id" @change="checkLocation('division', form.division_id)" disabled>
                ...
                <div class="col-md-4">
                    <select class="form-control" v-model="form.district_id" @change="checkLocation('district', form.district_id)" disabled>
                ...
                <div class="col-md-4">
                    <select class="form-control" v-model="form.thana_id" disabled>
...
<script>
    export default {
        ...
        mounted(){
            ...
            this.http('processing-plant/all', 'processing_plants ', { select:['id', 'processing_plant_name']});
        ...
        methods:{
            submit:function(){
                if(this.view_id){
                    this.http('user/update/'+this.view_id, 'update', this.form);
                }
