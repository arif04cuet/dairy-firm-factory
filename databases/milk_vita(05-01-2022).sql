...
INSERT INTO `action_menus` VALUES (1,'Edit','এডিট',7,0,'in_page','fa fa-pencil','/role/update',0,1,NULL,NULL),(2,'Edit','এডিট',8,0,'in_page','fa fa-pencil','/user/access/edit',0,3,NULL,NULL),(3,'Delete','ডিলিট',8,0,'in_page','fa fa-trash','/user/access/delete',0,4,NULL,NULL),(4,'Add New','নতুন যোগ করুন',8,0,'in_page','fa fa-plus','/user/access/add',0,2,NULL,NULL),(5,'Add New','নতুন যোগ করুন',7,0,'in_page','fa fa-plus','/role/add',0,1,NULL,NULL),(6,'Collect','সংগ্রহ',3,0,'in_page','fa fa-plus','/management/milk-collection/collect',0,1,NULL,NULL),(7,'List','তালিকা',3,0,'in_page','fa fa-list','/management/milk-collection/list',0,2,NULL,NULL),(8,'Add New','নতুন যোগ করুন',1,0,'in_page','fa fa-plus','/association/add',0,1,NULL,NULL),(9,'association-edit','association-edit',8,0,'in_page','fa fa-pencil','/association/edit',0,1,NULL,NULL),(10,'Member-Update','Member-Update',8,0,'in_page','fa fa-plus','/association/member',0,1,NULL,NULL);
...
-- Dump completed on 2022-01-05 12:12:27
